...
creadorLista :: AgenciaDeViajes -> [Int]
creadorLista [] = []
...
recursionListaDestinos :: AgenciaDeViajes -> [Ciudad] -> Ciudad -> Bool
...
listaDestinos :: AgenciaDeViajes -> Ciudad -> [Ciudad]
listaDestinos [] _ = []
...
duracionMasCorta :: [Duracion] -> Duracion
...
recursionListaDuraciones :: AgenciaDeViajes -> [Ciudad] -> Ciudad -> Ciudad -> [Duracion]
...
duracionVuelo :: AgenciaDeViajes -> Ciudad -> Ciudad -> Duracion
